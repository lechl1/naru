naru's documentation files are found in `docs/wiki/` and should be viewable and browsable in at least three systems:

- The GitHub repo's markdown file preview
- [The GitHub repo's wiki](https://github.com/lechl1/naru/wiki)
- [The documentation site](https://lechl1.github.io/naru/)
...
The documentation site should now be available on http://127.0.0.1:8000/naru/
