The name "naru" is canonically written in lower-case, but feel free to capitalize it if you'd like, especially at the start of sentences where the grammatical rules require it.
...
|        | full-sized                     | icon                           |
|--------|:------------------------------:|:------------------------------:|
| normal | ![](./logo/naru-logo.svg)      | ![](./logo/naru-icon.svg)      |
| simple | ![](./logo/naru-logo-smol.svg) | ![](./logo/naru-icon-smol.svg) |

The logo is intentionally recolorable.
In fact, there's [a webpage](https://narulogo.raurutuchr.ink) that lets you quickly adjust the color and download an SVG.
