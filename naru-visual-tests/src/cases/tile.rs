...
use naru::layout::Options;
use naru::render_helpers::xray::XrayPos;
use naru::render_helpers::{RenderCtx, RenderTarget};
use naru_config::Color;
...
pub struct Tile {
    window: TestWindow,
    tile: naru::layout::tile::Tile<TestWindow>,
}
...
impl Tile {
    ...
    pub fn with_window(args: Args, window: TestWindow) -> Self {
        ...
        let mut tile = naru::layout::tile::Tile::new(
            window.clone(),
            size.to_f64(),
            1.,
            clock,
