...
impl Animation {
    ...
    pub fn replace_config(&mut self, config: naru_config::Animation) {
        ...
        match config.kind {
            naru_config::animations::Kind::Spring(p) => {
            ...
            naru_config::animations::Kind::Easing(p) => {
                *self = Self::ease(
                    self.clock.clone(),
                    self.from,
                    self.to,
...
impl From<naru_config::animations::Curve> for Curve {
    fn from(value: naru_config::animations::Curve) -> Self {
        match value {
            naru_config::animations::Curve::Linear => Curve::Linear,
            naru_config::animations::Curve::EaseOutQuad => Curve::EaseOutQuad,
            naru_config::animations::Curve::EaseOutCubic => Curve::EaseOutCubic,
            naru_config::animations::Curve::EaseOutExpo => Curve::EaseOutExpo,
            naru_config::animations::Curve::CubicBezier(x1, y1, x2, y2) => {
