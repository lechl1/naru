...
use naru_config::utils::{Flag, MergeWith as _};
use naru_config::workspace::WorkspaceName;
use naru_config::{
...
enum Op {
    ...
    AddScaledOutput {
        ...
        layout_config: Option<Box<naru_config::LayoutPart>>,
    },
    ...
    UpdateConfig {
        ...
        layout_config: Box<naru_config::LayoutPart>,
    },
}
        ...
        match self {
            ...
            Op::AddNamedWorkspace {
                ...
                layout.ensure_named_workspace(&WorkspaceConfig {
                    ...
                    layout: layout_config.map(|x| naru_config::WorkspaceLayoutPart(*x)),
                });
            }
...
fn interactive_move_from_workspace_with_layout_config() {
    let ops = [
        Op::AddNamedWorkspace {
            ws_name: 1,
            output_name: Some(2),
            layout_config: Some(Box::new(naru_config::LayoutPart {
                border: Some(naru_config::BorderRule {
                    on: true,
                    ..Default::default()
                }),
                ..Default::default()
