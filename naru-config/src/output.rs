...
use knuffel::Decode;
use naru_ipc::{ConfiguredMode, HSyncPolarity, Transform, VSyncPolarity};
...
pub struct Modeline {
    ...
    pub hsync_polarity: naru_ipc::HSyncPolarity,
    /// Vertical sync polarity: "+vsync" or "-vsync".
    pub vsync_polarity: naru_ipc::VSyncPolarity,
}
...
impl OutputName {
    pub fn from_ipc_output(output: &naru_ipc::Output) -> Self {
        Self {
    ...
    pub fn matches(&self, target: &str) -> bool {
        ...
        //
        // This is used by naru msg output.
        if self.make.is_none() && self.model.is_none() && self.serial.is_none() {
            return false;
        }
